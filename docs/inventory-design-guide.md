## Designing Inventory for Inference Cluster Deployment
   ...
   - [Multi Master Node with Dedicated Intel Xeon, Intel® AI Accelerator and CPU nodes Deployment](#multi-master-multi-workload-node-with-dedicated-intel-xeon-ai-accelerator-and-cpu-nodes-deployment)
