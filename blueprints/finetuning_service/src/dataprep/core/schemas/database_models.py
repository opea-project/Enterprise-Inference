...
class FileMetadata(Base):
    ...
    file_data = Column(JSON, nullable=False, default={})
    ...
    def to_dict(self) -> dict:
        ...
        result = self.file_data.copy() if self.file_data else {}
        result['file_id'] = self.file_id
        if self.user_id:
            result['user_id'] = self.user_id
        # Return timestamps as Unix timestamps (integers) for API compatibility
