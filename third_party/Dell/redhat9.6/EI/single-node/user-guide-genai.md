# Intel® AI for Enterprise Inference - RedHat (Gen AI)
...
> * Set deploy_genai_gateway to on & deploy_keycloak_apisix to off
...
- Deployed Intel® AI for Enterprise Inference with genai
